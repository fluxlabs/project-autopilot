...
**ALWAYS use batch selection when processing multiple tasks.** This reduces orchestrator overhead by making a single model selection call for all tasks in a phase.
