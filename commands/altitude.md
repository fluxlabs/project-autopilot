...
// Project Autopilot - Altitude Check Command
...
Read these files:
- `.autopilot/TRANSPONDER.md` - Current position and session state
- `.autopilot/progress.md` - Recent activity
- `.autopilot/clearance.md` - Phase overview with estimates
- `.autopilot/token-usage.md` - Cost details
- `.autopilot/phases/NNN/PHASE.md` - Current phase
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🧭 AUTOPILOT: ALTITUDE
   Current flight position and fuel status
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
cat .autopilot/phases/004/PHASE.md
```
```
...
**No active flight found in this directory.**

Start with:
- `/autopilot:radar` - Scan project status
- `/autopilot:takeoff [description]` - Start new flight

Or view global stats:
- `/autopilot:altitude --global` - Stats across all flights
- `/autopilot:cockpit --list` - See resumable flights
```
...
**Since:** January 1, 2026 | **Last Flight:** January 25, 2026
...
| Project | Progress | Fuel | Remaining |
|---------|----------|------|-----------|
| cli-tool | 50% | $1.45 | ~$1.55 |

**Resume:** `/autopilot:cockpit --project=cli-tool`
...
### Most Used
1. **node-typescript-postgres** (5 flights) - Avg: $4.38
2. **react-nextjs** (3 flights) - Avg: $6.20
3. **python-fastapi** (2 flights) - Avg: $3.10
...
# Start new flight
/autopilot:takeoff [description]

# Resume in-progress flight
/autopilot:cockpit --project=cli-tool
```
```
...
📊 12 flights | $45.23 total | 94% accuracy
